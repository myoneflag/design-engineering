    ...
    <div>
        ...
        <div class="home"  style="overflow-y: auto; overflow-x: hidden; height: calc(100vh - 70px)">
            ...
            <b-row>
                <b-col>
                    <p>
                        These are from the <router-link to="/contact">Contact Us</router-link> page
                    </p>
                    <b-button variant="warning" v-if="profile.email == null" :to="'/users/username/' + profile.username">Set your email to subscribe</b-button>
            ...
            <b-row>
                <b-col>
                    <b-alert variant="success"  v-if="contacts.length === 0 && isLoaded" show>There are no contact messages right now</b-alert>
                </b-col>
            </b-row>
