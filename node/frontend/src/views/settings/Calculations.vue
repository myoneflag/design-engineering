...
import {
  ...
  getEN_12506_FREQUENCY_FACTOR_CHOICES,
  getPsdMethods,
...
export default class Calculations extends Vue {
  get fields(): any[][] {
    ...
    result.push([
      ...
      "choice",
      [...getPsdMethods(this.catalog), ...getDwellingMethods(this.catalog)]
    ]);
    ...
    result.push(["drainageMethod", "Drainage Method", "choice", DRAINAGE_METHOD_CHOICES]);
    ...
    result.push(
      ...
      ["roomTemperatureC", "Ambient Temperature", "range", 10, 40, null, Units.Celsius],
