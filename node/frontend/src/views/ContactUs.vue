<template>
    <b-container>
        ...
        <b-row class="text-center">
            ...
            <b-col cols="8">
                <h5 class="text-center">
                    Thank you for your interest in H2X. If you are interested in having early access to our software,
                    please contact us by completing the below form and we will be in touch shortly.
                </h5>
        ...
        <b-row style="margin-top: 50px;">
            ...
            <b-col cols="6">
                <iframe
                    src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:6606844300288499712"
                    height="616"
                    width="504"
                    frameborder="0"
                    allowfullscreen=""
        ...
        <b-row style="margin-top: 20px">
            <b-col>
                <b-button-group>
                    <b-button
                        href="https://www.linkedin.com/company/h2x-exponential-engineering/?viewAsMember=true"
                        variant="primary"
                        ><v-icon name="brands/linkedin" scale="2"
                    /></b-button>
                    <b-button href="mailto:jonathanmousdell@gmail.com" variant="danger"
    ...
    submit() {
        sendContactMessage(this.name, this.email, this.message).then((res) => {
            if (res.success) {
                ...
                this.$bvToast.toast(
                    "Hmm... we were unable to receive your message. Please contact jonathanmousdell@gmail.com directly, thanks!",
                    {
                        title: res.message,
                        variant: "danger",
                        solid: true
