...
import FittingEntity, { makeValveFields } from "../../../../../common/src/api/document/entities/fitting-entity";
...
export default class FittingProperties extends Vue {
  get fields() {
    return makeValveFields(this.document.drawing.metadata.flowSystems);
  }
