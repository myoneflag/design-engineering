                ...
                <b-col cols="12" style="height: 100%; background-color: aliceblue">
                    <b-card class="login-card">
                        ...
                        <b-form style="text-align: left">
                            ...
                            <b-form-group>
                                <b-button variant="success" @click="login" style="width: 100%" size="lg"
                                    >Login
                                </b-button>
                            </b-form-group>
                        </b-form>
                        ...
                        <b-btn variant="primary" pill href="https://www.h2xengineering.com/get-in-touch"
                            >Contact Us for a Free Trial</b-btn
                        >
                    </b-card>
                </b-col>
            </b-row>
