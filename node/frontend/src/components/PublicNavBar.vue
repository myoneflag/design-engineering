<template>
    <b-navbar type="light">
        <b-container style="max-width: 950px">
            ...
            <b-navbar-nav>
                <b-navbar-brand href="https://h2xengineering.com">
                    <img src="@/assets/h2x.png" class="d-inline-block align-top" height="70">
                </b-navbar-brand>
            ...
            <b-navbar-nav style="text-align: center; margin-left: auto; margin-right: auto;">
                ...
                <b-nav-item class="public-nav-item" href="https://h2xengineering.com/copy-of-questions">Tutorials</b-nav-item>
                <b-nav-item class="public-nav-item" href="https://h2xengineering.com/get-in-touch">Get in Touch</b-nav-item>
            </b-navbar-nav>

            <b-navbar-nav class="ml-auto">

            <ProfileMenuItem v-if="loggedIn" style="padding: 20px">
