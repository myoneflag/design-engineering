...
export interface PsdCountEntry {
  ...
  // gas
  gasMJH: number;
  gasMJHUnDiversified: number;
  gasMJHDiversified: number;
  gasDiversity: number;
...
export function addPsdCounts(
  ...
  if (
    document.drawing.metadata.calculationParams.drainageMethod === SupportedDrainageMethods.EN1205622000DischargeUnits
  ) {
    ...
    drainageUnits =
      aDrainageUnits > 0 && calculatedDrainageUnits > highestDrainageUnits
  ...
  return {
    ...
    gasMJHUnDiversified: a.gasMJHUnDiversified + b.gasMJHUnDiversified,
    gasMJHDiversified: Math.max(a.gasMJHDiversified, b.gasMJHDiversified),
    gasDiversity: a.gasDiversity + b.gasDiversity,
    drainageUnits,
    mainDrainageUnits,
    highestDrainageUnits,
    mixedHotCold,
...
export function addFinalPsdCounts(a: FinalPsdCountEntry, b: FinalPsdCountEntry): FinalPsdCountEntry {
  return {
    ...
    gasMJH: a.gasMJH + b.gasMJH,
    gasMJHUnDiversified: a.gasMJHUnDiversified + b.gasMJHUnDiversified,
    gasMJHDiversified: a.gasMJHDiversified + b.gasMJHDiversified,
    gasDiversity: a.gasDiversity + b.gasDiversity,
...
export function scalePsdCounts(a: PsdCountEntry, scale: number): PsdCountEntry {
  return {
    ...
    gasMJHUnDiversified: a.gasMJHUnDiversified * scale,
    gasMJHDiversified: a.gasMJHDiversified * scale,
    gasDiversity: a.gasDiversity * scale,
...
export function equalPsdCounts(a: PsdCountEntry, b: PsdCountEntry): boolean {
  return (
    ...
    Math.abs(a.gasMJHUnDiversified - b.gasMJHUnDiversified) < EPS &&
    Math.abs(a.gasMJHDiversified - b.gasMJHDiversified) < EPS &&
    Math.abs(a.gasDiversity - b.gasDiversity) < EPS &&
...
function isZeroPsdCounts(a: PsdCountEntry): boolean {
  return (
    ...
    Math.abs(a.gasMJHUnDiversified) < EPS &&
    Math.abs(a.gasMJHDiversified) < EPS &&
    Math.abs(a.gasDiversity) < EPS &&
...
export function countPsdProfile(
  ...
  profile.forEach((contextual) => {
    if (byCorrelated.has(contextual.correlationGroup)) {
      ...
      const max: PsdCountEntry = {
        ...
        gasMJHUnDiversified: Math.max(a.gasMJHUnDiversified, b.gasMJHUnDiversified),
        gasMJHDiversified: Math.max(a.gasMJHDiversified, b.gasMJHDiversified),
        gasDiversity: Math.max(a.gasDiversity, b.gasDiversity),
  ...
  byCorrelated.forEach((contextual) => {
    ...
    const gasMJHDiversified = Math.max(total.gasMJHDiversified, total.gasDiversity);
    total.gasMJH = total.gasMJHUnDiversified + gasMJHDiversified;
    total.gasMJHDiversified = gasMJHDiversified;
  });
  ...
  return {
    ...
    gasMJH: total.gasMJH,
    gasMJHUnDiversified: total.gasMJHUnDiversified,
    gasMJHDiversified: total.gasMJHDiversified,
    gasDiversity: total.gasDiversity,
...
export function subtractPsdProfiles(profile: PsdProfile, operand: PsdProfile): void {
  operand.forEach((contextual) => {
    ...
    profile.set(contextual.entity, {
      ...
      gasMJHUnDiversified: prev.gasMJHUnDiversified - contextual.gasMJHUnDiversified,
      gasMJHDiversified: prev.gasMJHDiversified - contextual.gasMJHDiversified,
      gasDiversity: prev.gasDiversity - contextual.gasDiversity,
...
export function resolveEN1205622000DrainageUnits(document: DocumentState, catalog: Catalog, drainageUnits: number) {
  const frequencyFactor =
    catalog.en12056FrequencyFactor[document.drawing.metadata.calculationParams.en12056FrequencyFactor];
...
export function getLevelHeightFloorToVertexM(levels: { [key: string]: Level }, levelUid: string): number | null {
  ...
  return sortedLevels[currentLevelIndex + 1].floorHeightM - sortedLevels[currentLevelIndex].floorHeightM;
}
