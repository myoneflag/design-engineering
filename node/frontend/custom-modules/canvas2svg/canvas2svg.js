 ...
 */
    ...
    ctx.prototype.getTransformAttributeChain = function() {
        // reconstruct the path to the root and record the transforms along the way.
        var transform = '';
        var curr = this.__currentElement;
        while (curr !== this.__root) {
            var thisTransform = curr.getAttribute('transform');
            if (thisTransform) {
                if (transform) {
                    transform = ' ' + transform;
                }
    ...
    ctx.prototype.setTransform = function (mat) {
        this.__currentElement = this.__document.createElementNS("http://www.w3.org/2000/svg", "g");
        this.__currentElementsToStyle = null;
        this.__root.appendChild(this.__currentElement);
        this.__currentElement.setAttribute("transform", '');
        this.transform(mat.a, mat.b, mat.c, mat.d, mat.e, mat.f);
    };
