			...
			switch (parentEntity.type) {
				...
				case EntityType.GAS_APPLIANCE: {
					...
					units.push({
						...
						gasMJH: 0,
						gasMJHUnDiversified: 0,
						gasMJHDiversified: filled.flowRateMJH!,
						...
						case PlantType.RETURN_SYSTEM:
							if (filled.plant.gasConsumptionMJH !== null && node.uid === filled.plant.gasNodeUid) {
								units.push({
									...
									gasMJH: 0,
									gasMJHUnDiversified: 0,
									gasMJHDiversified: filled.plant.gasConsumptionMJH,
									gasDiversity: filled.plant.gasConsumptionMJH * numToPercent(filled.plant.diversity!),
									drainageUnits: 0,
								});
							}
							break;
						...
						if (isGermanStandard(psdStandard)) {
							...
							if (systemChk) {
								...
								units.push({
									...
									entity: filled.uid + '-' + i,
									gasMJH: 0,
									gasMJHUnDiversified: filled.node.gasFlowRateMJH,
									gasMJHDiversified: 0,
									gasDiversity: 0,
					...
					case NodeType.LOAD_NODE:
						if (isGermanStandard(this.doc.drawing.metadata.calculationParams.psdMethod)) {
							units.push({
								...
								gasMJH: 0,
								gasMJHUnDiversified: 0,
								gasMJHDiversified: filled.node.gasFlowRateMJH,
					...
					case NodeType.DWELLING:
						if (!!this.doc.drawing.metadata.calculationParams.dwellingMethod) {
							units.push({
								...
								entity: filled.uid,
								gasMJH: 0,
								gasMJHUnDiversified: filled.node.gasFlowRateMJH * filled.node.dwellings!,
								gasMJHDiversified: 0,
								gasDiversity: 0,
								drainageUnits: drainageUnits!,
								correlationGroup
