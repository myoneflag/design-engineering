...
export function makeLoadNodesFields(
    ...
    switch (value.node.type) {
        case NodeType.LOAD_NODE:
            ...
            fields.push(
                { property: 'node.loadingUnits', title: 'Loading Units', hasDefault: false, isCalculated: false,
                    type: FieldType.Number, params: { min: 0, max: null },  multiFieldId: 'loadingUnits' },

                { property: 'node.designFlowRateLS', title: 'Design Flow Rate (L/s)', hasDefault: false, isCalculated: false,
                    type: FieldType.Number, params: { min: 0, max: null },  multiFieldId: 'designFlowRateLS' },

                { property: 'node.continuousFlowLS', title: 'Continuous Flow (L/s)', hasDefault: false, isCalculated: false,
        ...
        case NodeType.DWELLING:
            ...
            fields.push(
                { property: 'node.dwellings', title: 'Dwelling Units', hasDefault: false, isCalculated: false,
                    type: FieldType.Number, params: { min: 0, max: null },  multiFieldId: 'dwellings' },
            );
            break;
    }
