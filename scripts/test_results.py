...
class test_results(unittest.TestCase):
    ...
    def test_filters(self):
        ...
        # size_checkbox = self.driver.find_element_by_xpath("//div[@class='filterPanel']//div[1]//div[4]//input[1]")
        ...
        flowrate_checkbox = self.driver.find_element_by_xpath("//div[@class='row']//div[2]//div[4]//input[1]")
        ...
        # self.assertTrue(size_checkbox.is_enabled())
        # print("Size checkbox enabled...")
        # self.driver.find_element_by_xpath("//label[contains(text(),'Size')]").click()
        # self.assertTrue(size_checkbox.is_selected())
        # print("Size checkbox checked...")
        ...
        # self.assertFalse(size_checkbox.is_enabled())
